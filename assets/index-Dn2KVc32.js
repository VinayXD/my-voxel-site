...
void main() {
    ...
    <div class="row">
      <a class="btn" id="cta" href="${W0}" download="Vinay_Peddireddy_Resume.pdf" rel="noopener" style="
        width: 100%; 
